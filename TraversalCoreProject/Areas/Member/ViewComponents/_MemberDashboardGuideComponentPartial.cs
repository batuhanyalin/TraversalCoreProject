...
{
    public class _MemberDashboardGuideComponentPartial : ViewComponent
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly IMapper _mapper;

        public _MemberDashboardGuideComponentPartial(UserManager<AppUser> userManager, IMapper mapper)
        {
