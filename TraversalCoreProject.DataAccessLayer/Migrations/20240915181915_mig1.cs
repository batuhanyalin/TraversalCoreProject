        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherLanguage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    IsFeaturePost = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IndexBannerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndexBanners", x => x.IndexBannerId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DestinationMatchGuides",
                columns: table => new
                {
                    DestinationMatchGuideId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DestinationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DestinationMatchGuides", x => x.DestinationMatchGuideId);
                    table.ForeignKey(
                        name: "FK_DestinationMatchGuides_AspNetUsers_GuideId",
                        column: x => x.GuideId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestinationMatchGuides_Destinations_DestinationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DestinationMatchGuides_DestinationId",
                table: "DestinationMatchGuides",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_DestinationMatchGuides_GuideId",
                table: "DestinationMatchGuides",
                column: "GuideId");
        }
